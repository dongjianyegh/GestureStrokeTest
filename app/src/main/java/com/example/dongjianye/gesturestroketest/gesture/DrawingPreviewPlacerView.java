...
public final class DrawingPreviewPlacerView extends RelativeLayout {
    private final static String TAG = DrawingPreviewPlacerView.class.getSimpleName();

    private final int[] mKeyboardViewOrigin = CoordinateUtils.newInstance();
    private final int[] mSelfViewOrigin = CoordinateUtils.newInstance();

    private final ArrayList<AbstractDrawingPreview> mPreviews = new ArrayList<>();

    public DrawingPreviewPlacerView(final Context context) {
        this(context, null);
    }
    ...
    public void setKeyboardViewGeometry(final int[] originCoords, final int width,
        ...
        getLocationInWindow(mSelfViewOrigin);
        CoordinateUtils.offset(mKeyboardViewOrigin, mSelfViewOrigin);
    ...
    public void onDraw(final Canvas canvas) {
        ...
        Log.w(TAG, "orginX is " + originX + ", originY is " + originY);
